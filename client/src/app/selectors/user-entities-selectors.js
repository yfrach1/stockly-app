...
export const getStockDetails = (state) => getUserEntities(state).stockDetails.stockInfo;
...
export const getStockRevenu = (state) => getUserEntities(state).stockDetails.stockRevenue;
export const getStockDiffPercent = (state) => getUserEntities(state).stockDetails.stockDiffPercent;
