   ...
   return (
      <Fragment>
         ...
         <div className={styles.text}>
            ...
            <br /> See the possibilities of your portfolio with our newly designed website.
         </div>
         <div className={styles.linksPosition}>
            <Link className={styles.signInButton} id={styles.option} to={ClientRoute.Guest.signIn}>
               SIGN IN
            </Link>
            <Link
