      ...
      <div className={styles.stockDetailsContainer}>
         ...
         <div className={styles.detailsAndAddContainer}>
            <div className={styles.details}>
               <span>Open: {stockInfo.length ? `${stockInfo.at(-1).open}` : ""}</span>
               <span>High: {stockInfo.length ? `${stockInfo.at(-1).high}` : ""}</span>
               <span>Low: {stockInfo.length ? `${stockInfo.at(-1).low}` : ""}</span>
               <span>Volume: {stockInfo.length ? `${stockInfo.at(-1).volume / 1000} K` : ""}</span>
            </div>
